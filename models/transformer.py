...
class Transformer(nn.Module):
    r"""A transformer model, which remove shortcut to avoid leakage of queries in decoder. User is able to modify the attributes as needed. The architecture
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None, memory_mask: Optional[Tensor] = None,
        ...
        if self.norm_first:
            ...
            x = self.norm1(self._sa_block(x, tgt_mask, tgt_key_padding_mask))

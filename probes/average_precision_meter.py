...
class AveragePrecisionMeter:
    ...
    def add(self, output:Tensor, target:Tensor, filename:List[str]):
        ...
        self.scores=torch.cat([self.scores,output.cpu()],dim=0)
        self.targets=torch.cat([self.targets,target.cpu()],dim=0)
    ...
    def evaluation(self, scores_, targets_):
        ...
        # Nc: number of correct positive prediction
        # Np: number of inputs predicted as positive
        # Ng: number of target tags as positive
